...
papers, projects, Wikipedia, social media and Human Resources
Documentation (job profiles). Before starting to analyze the state of
the art techniques to perform knowledge extraction for these documents,
the focus is on a task that has intentionally not been analyzed in
section \ref{sotatools}: understanding.
...
\subsubsection{Economics and Social
Media}\label{economics-and-social-media}
...
\chapter{Applications and Results}\label{applications}
