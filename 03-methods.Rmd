...
In this section we show the approach used to extract the advantages and the drawbacks of the invention described in a patent. The proposed process is shown in figure \@ref(fig:procesuser) and its phases are:
